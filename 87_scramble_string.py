...
class Solution:
    ...
    def isScramble(self, s1: str, s2: str) -> bool:
        ...
        if (s1, s2) in Solution.memotable:
            return Solution.memotable[(s1, s2)]
        if s1 == s2:
            Solution.memotable[(s1, s2)] = True
            Solution.memotable[(s2, s1)] = True
            return True
        ...
        Solution.memotable[(s1, s2)] = result
        Solution.memotable[(s2, s1)] = result
        return result
